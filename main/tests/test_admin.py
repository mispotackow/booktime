...
class TestAdminViews(TestCase):
    def test_most_bought_products(self):
        products = [factories.ProductFactory(name='A', active=True),
    ...
    def test_invoice_renders_exactly_as_expected(self):
        products = [factories.ProductFactory(name='A', active=True, price=Decimal('10.00')),
        ...
        with patch('django.utils.timezone.now') as mock_now:
            ...
            order = factories.OrderFactory(id=12,
            ...
            with open('main/fixtures/invoice_test.pdf', 'rb') as fixture:
                expected_content = fixture.read()
            self.assertEqual(content, expected_content)
