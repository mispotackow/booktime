...
class TestPage(TestCase):
    ...
    def test_address_list_page_returns_only_owned(self):
        ...
        # Если ваш сайт использует систему авторизации Django, вы можете использовать метод force_login()
        # чтобы эмулировать авторизацию пользователя на вашем сайте. Используйте этот метод вместо login(),
        # если необходимо авторизировать пользователя в тестах и при этом не важен способ авторизации.
